...
export default function CompleteDiscog() {
  const [{ data: recordings, loading, error }, refetch] = useAxios('https://slownames.net/api/recordings?populate=*&filters[bands][name]=Hey%20Exit&filters[visibility][$ne]=hidden&pagination[pageSize]=100');
