      ...
      <div className="content-projects tethers-container">
        ...
        <div className="project-content">
          ...
          <SingleRelease id="y2e8v4phxa3udlwqok212zzy" displayArtist={false}>
            <p>
              Arvo P&auml;rt's classic short-form piece, played on two guitars.
            </p>
          </SingleRelease>
          ...
          <SingleRelease id="xcfr9c0qbpc4k63hylvu2vsn" displayArtist={false}>
            <p>
              ...
              speakers in the same spaces. A moderate hassle in retrospect, but
              then again the tunes turned out pretty nice.
            </p>
            <p>
              The "before" and "after" tracks both have this no-begining-no-end
              quality to them that I find now to be deeply unmusical in a
              charmingly naive way. Some work better than others.
            </p>
          </SingleRelease>
          <SingleRelease id="n5pb9a3o9n0l34tbdq9y6irs" displayArtist={false}>
            Our first recordings in the banjo / koto configuration, now lost to the
            sands of time...
          </SingleRelease>
