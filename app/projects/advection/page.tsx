      ...
      <div className="content-projects advection-container">
        ...
        <div className="project-content">
          <SingleRelease id="vymkfdtzdzrbawkmwzt8ws17" displayArtist={false}>
            <p>
              A half-hour set of hazy, mid-tempo electronic tunes. Some of these
              were rescued from ancient folders full of unfinished session files
              and repurpsed, others were put together during the quarantine era
              of 2020. A bit of a transitional document.
            </p>
          </SingleRelease>
          <SingleRelease id="gqczm6y6moxvwux1y9qb70ww" displayArtist={false}>
            <p>
              An ode to one of my favorite instrumental release formats: the 2CD
              ambient album.
            </p>
          </SingleRelease>
          <h2>precursors</h2>
          ...
          <SingleRelease id="r02cjr0zz5de4tgqbw0biyke" displayArtist={false}>
            <p>...while the "Hi" EP is more aggressive and brightly colored.</p>
          </SingleRelease>
        </div>
      </div>
    </>
