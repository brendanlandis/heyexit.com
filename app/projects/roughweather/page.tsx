      ...
      <div className="content-projects roughweather-container">
        ...
        <div className="project-content">
          <p className="project-intro">
            ...
            standard-bearer and rad dude Erik Schoster (
            <strong>He Can Jog</strong>). A bit of a Jetsons-Meet-the-Flinstones
            affair in terms of instruments, the project juxtaposed Schoster's
            live computer music with my rocks-and-sticks approach to prepared
            guitar and amplified objects.
          </p>
          <Gigography
            band="Rough Weather"
            displayImages={false}
